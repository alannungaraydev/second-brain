...
## Chapter 2 STRATEGIC DESIGN WITH BOUNDED CONTEXT AND THE UBIQUITOUS LANGUAGE

DDD is primarily about modeling a ubiquitous language (a common language and shared by all the team members and stakeholders)  in a bounded context

![[Pasted image 20230501102020.png]]
This should be rigorous--strict, exact, stringent, and tight.

To avoid the big ball of mud the UL(ubiquitous language) should be understood by the context 
![[Pasted image 20230501114211.png]]
